            ...
            <div class="row">
                ...
                <div class="main col-md-8">
                    ...
                    <h1 class="page-title"><i class="fa fa-save"></i> File Manager
                        <div class="pull-right"><a href="#" class="fileinput-button btn btn-success"><i
                                    class="fa fa-plus"></i> Upload</a></div>
                    </h1>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content clear-style">
                            <div class="tab-pane active" id="pill-1">
                                <div class="row masonry-grid-fitrows grid-space-12" style="position: relative;"
                                    id="previews">
                                                    ...
                                                    <div class="" style="height: 55px; text-align: center;">
                                                        <h3 style="font-size: 16px;">
                                                            <a href="#" data-toggle="tooltip"
                                                                ...
                                                                <p class="name">
                                                                    {{ str_limit($file->original_name, $limit = 45, $end = '...') }}
                                                                </p>
                                                            </a>
                                                        </h3>
                                                    </div>
