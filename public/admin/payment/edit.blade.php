...
@section('content')
    ...
    @push('scripts')
        <script type="text/javascript"
            src="https://openportl.io/bower_components/EasyAutocomplete/dist/jquery.easy-autocomplete.min.js"></script>
                    ...
                    <div class="main col-md-12">
                            ...
                            <div class="col-md-2">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" class="form-control disabled"
                                        placeholder="${{ $invoice->usd_amount }}" name="usd_amount" id="usd_amount"
                                        style="width: 150px; padding-right: 0px;" disabled>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group has-feedback">
                                    <label for="name3">Unpaid</label>
                                    <input type="text" class="form-control" placeholder="USD Amount" name="total_unpaid"
                                        style="width: 150px; padding-right: 0px;" value="{{ $invoice->total_unpaid }}">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group has-feedback">
                                    <label for="name3">Paid</label>
                                    <input type="text" class="form-control" placeholder="USD Amount" name="total_paid"
                                        style="width: 150px; padding-right: 0px;" value="{{ $invoice->total_paid }}">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status">
                                        <option value="unpaid" @if ($invoice->status == 'unpaid') selected @endif>Unpaid
                                        </option>
                                        <option value="partial" @if ($invoice->status == 'partial') selected @endif>Partial
                                            Payment</option>
                                        <option value="paid" @if ($invoice->status == 'paid') selected @endif>Full
                                            Payment</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Client</label>
                                    <input class="form-control input-sm" id="sheroes" placeholder="Type a client's name"
                                        type="text" name="client_name"
                                        value="{{ $invoice->Client->name }} (#{{ $invoice->Client->id }})"><span
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" class="form-control" placeholder="Notes" name="description"
                                style="padding-right: 0px;" value="{{ $invoice->description }}">
                        </div>
                                ...
                                <div class="row" id="line_item_template">
                                    <div class="col-md-1">
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" class="form-control line_item_rate" placeholder="$0.00"
                                                name="rate[]" style="width: 80px; padding-right: 0px;" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" class="form-control line_item_hours" name="hours[]"
                                                placeholder="Hrs" style="width: 80px; padding-right: 0px;"
                                                value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="line_item">
                                        <div class="row">
                                            <div class="col-md-1">
                                                <div class="form-group has-feedback">
                                                    <label for="name3">Rate</label>
                                                    <input type="text" class="form-control line_item_rate"
                                                        placeholder="$0.00" name="rate[]"
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group has-feedback">
                                                    <label for="name3">Hours</label>
                                                    <input type="text" class="form-control line_item_hours"
                                                        name="hours[]" placeholder="Hrs"
                                                        style="width: 80px; padding-right: 0px;"
                                                        value="{{ $item->hours }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-group has-feedback">
                                                    <label for="name3">Description</label>
                                                    <input type="text" class="form-control" name="description[]"
                                                        style=" padding-right: 0px;" value="{{ $item->description }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="category_id[]">
                                                        <option value="1"
                                                            @if ($item->Category->id == '1') selected @endif>Software
                                                            Engineering</option>
                                                        <option value="2"
                                                            @if ($item->Category->id == '2') selected @endif>Database
                                                            Administration</option>
                                                        <option value="3"
                                                            @if ($item->Category->id == '3') selected @endif>Server
                                                            Engineering (DevOps)</option>
                                                        <option value="4"
                                                            @if ($item->Category->id == '4') selected @endif>Marketing /
                                                            SEO</option>
                                                        <option value="5"
                                                            @if ($item->Category->id == '5') selected @endif>Interface /
                                    ...
                                    <tbody>
                                        @foreach ($invoice->Payments as $payment)
                                            <tr>
                                                ...
                                                <td><span
                                                        style="font-weight: 800; color: @if ($payment->status == 'confirmed') green @else red @endif;">{{ ucfirst($payment->status) }}</span>
                                                </td>
