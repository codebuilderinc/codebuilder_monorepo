        ...
        <div class="container">
            <div class="row">
                ...
                <div class="main col-md-8">
                    <!-- page-title start -->
                    <!-- ================ -->
                    <h1 class="page-title" style="text-transform: none;"><i class="fa fa-user"></i> {{ $client->firm }}
                    ...
                    <form role="form" id="client-form" class="margin-clear">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" class="form-control" id="name3" placeholder="Enter full name"
                                name="name" value="{{ $client->name }}">
                            <i class="fa fa-user form-control-feedback"></i>
                        </div>
                        <div class="form-group has-feedback">
                            <label for="email3">Email address</label>
                            <input type="email" class="form-control" id="email3" placeholder="Enter email address"
                                name="email" value="{{ $client->email }}">
                            <i class="fa fa-envelope form-control-feedback"></i>
                        </div>
                        <div class="form-group has-feedback">
                            <label for="name3">Firm Name</label>
                            <input type="text" class="form-control" id="name3" placeholder="Enter firm name"
                                name="firm" value="{{ $client->firm }}">
                            <i class="fa fa-cube form-control-feedback"></i>
                        </div>
                        <div class="form-group has-feedback">
                            <label for="name3">Phone</label>
                            <input type="text" class="form-control" id="name3" placeholder="Enter phone number"
                                name="phone" value="{{ $client->phone }}">
                            <i class="fa fa-phone form-control-feedback"></i>
                        </div>
                        <div class="form-group has-feedback">
                            <label for="name3">Fax</label>
                            <input type="text" class="form-control" id="name3" placeholder="Enter fax number"
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <textarea class="form-control" rows="4" id="message3" placeholder="" name="address"
                                value="{{ $client->address }}"></textarea>
                                ...
                                <tbody>
                                    @foreach ($client->Invoices as $invoice)
                                        <tr>
                                            ...
                                            <td><a
                                                    href="/admin/invoice/view/{{ $invoice->id }}">{{ $invoice->identifier }}</a>
                                            </td>
                        ...
                        <div class="block" style="margin-bottom: 10px;">
                            ...
                            <ul>
                                @foreach ($client->Timesheets as $timesheet)
                                    <li>{{ number_format($timesheet->mins / 60, 2) }} hrs - {{ $timesheet->user->name }}
                                        ({{ Carbon\Carbon::parse($timesheet->start)->format('d/m') }}) </li>
                                @endforeach
                            </ul>
