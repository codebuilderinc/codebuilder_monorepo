...
Route::get('/jobs/messaged', [App\Http\Controllers\HomeController::class, 'messagedJobs'])->name('messagedJobs');

Route::get('/job/message/{id}', [App\Http\Controllers\HomeController::class, 'msgJob'])->name('jobs');
Route::post('/job/message/{id}',  [App\Http\Controllers\HomeController::class, 'postMsgJob']);
Route::post('/job/reject/{id}', [App\Http\Controllers\HomeController::class, 'postRejectJob']);
Route::post('/job/restore/{id}', [App\Http\Controllers\HomeController::class, 'postRestoreJob']);
