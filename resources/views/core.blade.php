...
@else
    ...
    <head>
        ...
        <meta name="keywords"
            content="Software Engineering Solutions, Web Development, Graphic Design, Online Marketing, MySQL, PHP, Python, Ruby on Rails, Laravel, Composer, Wordpress, Node.JS" />
                            ...
                            <div class="col-md-2 ">
                                <table style="position: relative; top: 10px; " id="logo_table">
                                    <tbody style="background: transparent !important;">
                                        <tr>
                                            <td style="width: 60px;">
                                                <img src="/images/mandala4_75.png" style="max-width: 55px;"
                                                    id="logo_img">
                                            </td>
                                            <td id="logo_txt_td">
                                                <!-- logo -->
                                                <div id="logo" class="logo"
                                                    ...
                                                    <h3 style="margin-bottom: 0px;"
                                                        class="title logo-font object-non-visible animated object-visible fadeIn"
                                                        data-animation-effect="fadeIn" data-effect-delay="100"><span
                                                            class="text-default">CodeBuilder</span> Inc.</h3>
                                                </div>
                                                <!-- name-and-slogan -->
                                            ...
                                            <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper"
                                                ...
                                                <ul class="nav sidebar-nav">
                                                    <li class="sidebar-brand">
                                                        <table style="position: relative; top: 10px; width: 150%;"
                                                            id="logo_table">
                                                            <tbody style="background: transparent !important;">
                                                                <tr>
                                                                    <td style="width: 60px;">
                                                                        <img src="/images/mandala4_75.png"
                                                                            style="max-width: 45px; left: 5px; position: relative; top: 8px;"
                                                                            id="logo_img"
                                                                            alt="CodeBuilder, Inc. Web Development Software Engineering Developers & Consultants.">
                                                                    </td>
                                                                    <td id="logo_txt_td">
                                                                        <!-- logo -->
                                                                        <div id="logo" class="logo">
                                                                            <h3 style="margin-bottom: 0px;"
                                                                                ...
                                                                                data-effect-delay="100"><span
                                                                                    class="text-default">CodeBuilder</span>.io
                                                                            </h3>
                                                                        </div>
                                                                        <!-- name-and-slogan -->
                                                                        <div class="site-slogan"
                                                                            style="position: relative; top:-20px; height: 10px;">
                                                                            &nbsp;Software Engineering Solutions
                                                                        </div>
                                                                    </td>
                                                                </tr>
         ...
         <a href="/faq" class="pjax">FAQ</a>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="header-dropdown-buttons">
                                                            <a href="javascript: void(0);"
                                                                class="btn btn-sm hidden-xs btn-default dropdown-toggle"
                                                                data-toggle="dropdown" aria-expanded="true">Pay
                                                                Invoice <i class="fa fa-credit-card-alt"
                                                                    style="font-size: 13px;"></i></a>
                                                            <a href="javascript: void(0);"
                                                                class="btn btn-lg visible-xs btn-block btn-default dropdown-toggle"
                                                                data-toggle="dropdown" aria-expanded="true">Pay
                                                                Invoice <i class="fa fa-credit-card pl-5"></i></a>
                                                            <form class="invoice_modal_form">
                                                                <ul
                                                                    class="dropdown-menu dropdown-menu-right dropdown-animation cart">
                                                                    <li style="padding: 10px;">
                                                                        <div class="form-group has-feedback"
                                                                            style="margin-bottom: 0px;">
                                                                            <label for="name">Enter your invoice
                                                                                #:</label>
                                                                            <input class="form-control invoice_text"
                                                                                style="background-color: white;"
                                                                                name="name" placeholder="Invoice #"
                                                                                type="text">
                                                                        </div>
                                                                        <div class="panel-body text-right"
                                                                            style="padding: 0px;">
                                                                            <button
                                                                                class="btn btn-group btn-gray btn-sm invoice_a"
                                                                                type="submit">
              ...
              <a href="/faq" class="pjax">FAQ</a>
                                                    ...
                                                    <div class="header-dropdown-buttons">
                                                        <a href="javascript: void(0);"
                                                            class="btn btn-sm hidden-xs btn-default dropdown-toggle"
                                                            data-toggle="dropdown" aria-expanded="true">Pay Invoice <i
                                                                class="fa fa-credit-card-alt"
                                                                style="font-size: 13px;"></i></a>
                                                        <a href="mailto:info@codebuilder.us"
                                                            class="btn btn-lg visible-xs btn-block btn-default">Pay
                                                            Invoice <i class="fa fa-credit-card pl-5"></i></a>
                    ...
                    <div class="container">
                        <div class="footer-inner text-center" style="width: 100%; text-align: center; padding: 0px;">
                            <div class="row text-center hidden-sm-down"
                                style="display: inline-block; max-width: 750px;">
                                <nav>
                        ...
                        <div class="subfooter-inner">
                            <div class="row text-center" style="display: inline-block; padding-bottom: 10px;">
                                <div style="text-align: center; margin-bottom: 5px;"><img
                                        ...
                                        alt="We accept payments via Credit Card (processed by Stripe.com), PayPal.com, Bank Transfers, and Bitcoin. Other Crypto-Currencies may also be accepted on a case by case basis."
                                        id="payments_accepted" style="display: inline; height: 50px;"></div>


                                <div
                                    style="text-align: center; padding-bottom: 5px !important; position: relative; top: 0px;">
                                    <ul class="social-links">
                                        <li><a target="_blank" href="http://www.facebook.com/codebuilder.us"
                                                data-toggle="tooltip" title="Facebook"><i class="fa fa-facebook"
                                                    style="color: #4267B2;"></i></a></li>
                                        <li><a target="_blank" href="http://www.twitter.com/codebuilderio"
                                                data-toggle="tooltip" title="Twitter"><i class="fa fa-twitter"
                                                    style="color: #1DA1F2;"></i></a></li>
                                        <li><a target="_blank"
                                                href="https://plus.google.com/u/1/108752322274477001531"
                                                data-toggle="tooltip" title="Google+"><i class="fa fa-google-plus"
                                                    style="color: #E05E53;"></i></a></li>
                                        <li><a target="_blank" href="skype: andrew.c.corbin" data-toggle="tooltip"
                                                title="Skype"><i class="fa fa-skype"
                                                    style="color: #05ACF2;"></i></a></li>

                                        <li><a target="_blank" href="https://www.linkedin.com/company/25053333/"
                                                data-toggle="tooltip" title="LinkedIn"><i class="fa fa-linkedin"
                                                    style="color: #0077B5;"></i></a></li>
                                        <li><a target="_blank" href="https://www.reddit.com/user/codebuilder_inc"
                                                data-toggle="tooltip" title="Reddit"><i class="fa fa-reddit"
                                                    style="color: #7FC2FE;"></i></a></li>
                                    </ul>
                                </div>
                                <div>
                                    <div class="col-md-4"
                                        style="padding-right: 0px; padding-left: 0px; margin-top: 5px;">
                                        <a href="mailto:info@codebuilder.us" style="color: #777777;">
                                            <i class="fa fa-envelope pr-10"
                                                style="padding-right: 0px; color: #09afdf;"></i>
                                            info@codebuilder.us
                                        </a>
                                    </div>
                                    <div class="col-md-4"
                                        ...
                                        <a href="tel:+16125672633" style="color: #777777;">
                                            <i class="fa fa-phone pr-10 text-default" style="padding-right: 0px;"></i>
                                            +1 (612) 567-2633
                                        </a>
                                    </div>
                                    <div class="col-md-4"
                                        style="padding-right: 0px; padding-left: 0px;margin-top: 5px;">
                                        <i class="fa fa-map-marker pr-10 text-default"
